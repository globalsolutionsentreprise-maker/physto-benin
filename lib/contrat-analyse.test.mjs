...
// ── Encaissement des passages de contrat ────────────────────────────────────
...
test("resumeContrat agrege encaisse / duTotal / resteDu et alertes", () => {
  ...
  assert.equal(r.passages[1].statutPaiement, "alerte")
...
test("paiementsParPassages: vrai des qu'un passage porte un montant du", () => {
  assert.equal(paiementsParPassages([{ montant_du: 0 }, { montant_du: 50000 }]), true)
  assert.equal(paiementsParPassages([{ montant_du: 0 }, {}]), false)
  assert.equal(paiementsParPassages([]), false)
  assert.equal(paiementsParPassages(null), false)
})
