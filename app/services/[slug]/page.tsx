...
const SERVICES: Record<string, {
  ...
  "desinsectisation-cotonou": {
    ...
    description: "Cafards, fourmis, moustiques, mouches, on choisit la bonne méthode selon votre situation : gel appât, pulvérisation résiduelle ou fumigation. Techniciens certifiés.",
    tag: "Devis gratuit",
    ...
    faqs: [
      ...
      { q: "Faut-il une deuxième intervention ?", r: "Pour les cafards, on recommande un passage de contrôle 3 à 4 semaines après, c'est le temps que mettent les œufs à éclore. Ça évite les rechutes et réduit fortement le risque de rechute." },
  ...
  "anti-termites-benin": {
    ...
    description: "Protection durable de vos structures contre les termites au Bénin. Barrière chimique en profondeur, traitement par injection et protection longue durée avec contrôle annuel inclus.",
    tag: "Protection longue durée",
    details: ["Diagnostic complet des structures bois et béton", "Barrière chimique par injection en profondeur", "Traitement du bois et des fondations", "Protection longue durée sur le traitement", "Contrôle annuel inclus dans le contrat"],
    metaTitle: "Anti-termites Bénin, Protection Structures | Protection Longue Durée | Phyto Bénin",
    metaDesc: "Traitement anti-termites professionnel au Bénin. Protection bois, béton et fondations. Barrière chimique certifiée, protection longue durée, contrôle annuel. Devis gratuit.",
    ...
    faqs: [
      ...
      { q: "Quelle est la durée d'efficacité du traitement ?", r: "Un contrôle annuel est inclus dans le contrat. La durée exacte d'efficacité dépend du type de traitement réalisé, on vous l'indique clairement avant de commencer." },
  ...
  "punaises-de-lit-cotonou": {
    ...
    description: "Traitement complet des punaises de lit à Cotonou. Traitement thermique à 60°C et traitement chimique certifié. Inspection intégrale du mobilier.",
    tag: "Traitement thermique 60°C",
    details: ["Inspection complète du mobilier et literie", "Traitement thermique à 60°C, technique la plus efficace", "Traitement chimique résiduel complémentaire", "Protection des matelas incluse", "Contrôle de suivi après l'intervention"],
    metaTitle: "Punaises de Lit Cotonou, Traitement Thermique 60°C | Phyto Bénin",
    metaDesc: "Élimination punaises de lit à Cotonou et au Bénin. Traitement thermique à 60°C + traitement chimique certifié. Inspection complète du mobilier. Hôtels et particuliers.",
