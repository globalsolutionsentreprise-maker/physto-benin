...
const SERVICES_DEFAUT = [
  { id: 1, ico: "🪳", titre: "Désinsectisation", accroche: "Cafards · Fourmis · Moustiques · Mouches", description: "Élimination complète et durable de tous les insectes nuisibles. Traitements par gel appât, pulvérisation résiduelle et fumigation professionnelle.", tag: "Devis gratuit sous 2h", details: ["Diagnostic complet et gratuit", "Gel appât professionnel longue durée", "Pulvérisation résiduelle certifiée", "Fumigation pour les cas sévères", "Contrat de suivi mensuel disponible"] },
  { id: 2, ico: "🐀", titre: "Dératisation", accroche: "Rats · Souris · Rongeurs", description: "Intervention sécurisée et efficace contre les rongeurs. Pièges homologués, raticides certifiés, sécurisation des accès et suivi mensuel.", tag: "Contrat mensuel disponible", details: ["Inspection complète des zones à risque", "Pièges professionnels certifiés", "Raticides homologués et sécurisés", "Sécurisation des points d'entrée", "Rapport d'intervention et suivi"] },
  { id: 3, ico: "🧴", titre: "Désinfection", accroche: "Assainissement · Virucide · Bactéricide", description: "Assainissement complet de vos locaux avec produits virucides, bactéricides et fongicides. Certifié restaurants, hôtels et établissements de santé.", tag: "Certificat officiel remis", details: ["Désinfection totale des surfaces", "Produits virucides certifiés OMS", "Conforme aux normes sanitaires", "Certificat d'hygiène officiel remis", "Traitement adapté aux ERP"] },
  { id: 4, ico: "🐜", titre: "Anti-termites", accroche: "Protection bois et béton", description: "Protection durable de vos structures. Barrière chimique en profondeur, traitement par injection et garantie longue durée avec contrôle annuel.", tag: "Garantie longue durée", details: ["Diagnostic complet des structures", "Barrière chimique par injection", "Traitement du bois et fondations", "Garantie longue durée", "Contrôle annuel inclus"] },
  { id: 5, ico: "🐍", titre: "Reptiles et Serpents", accroche: "Geckos · Serpents · Lézards", description: "Sécurisation complète contre les reptiles. Répulsifs professionnels longue durée, barrières physiques et intervention urgence en moins de 2h.", tag: "Urgence — 2h à Cotonou", details: ["Intervention d'urgence en moins de 2h", "Répulsifs professionnels longue durée", "Sécurisation périmétrique complète", "Pose de barrières physiques", "Suivi post-intervention inclus"] },
