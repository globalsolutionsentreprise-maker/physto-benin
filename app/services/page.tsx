...
const SERVICES_DEFAUT = [
  ...
  { id: 4, ico: "🐜", titre: "Anti-termites", slug: "anti-termites-benin", accroche: "Protection bois et béton", description: "Les termites détruisent en silence. On les stoppe avec une barrière chimique par injection, garantie longue durée, contrôle annuel inclus.", tag: "Garantie longue durée", details: ["Diagnostic complet des structures", "Barrière chimique par injection", "Traitement du bois et fondations", "Garantie longue durée", "Contrôle annuel inclus"] },
