...
export const metadata: Metadata = {
  ...
  description:
    "Phyto Bénin (Global Solutions Entreprise) : spécialiste de l'hygiène sanitaire au Bénin, agréé par l'État. Techniciens certifiés, produits homologués OMS. Intervention rapide à Cotonou et dans tout le Bénin.",
  alternates: { canonical: "https://www.phyto-benin.com/qui-sommes-nous" },
  openGraph: {
    title: "Qui sommes-nous, Phyto Bénin by GSE",
    description:
      "Spécialiste de l'hygiène sanitaire au Bénin, agréé par l'État. Techniciens certifiés et produits homologués OMS, partout au Bénin.",
